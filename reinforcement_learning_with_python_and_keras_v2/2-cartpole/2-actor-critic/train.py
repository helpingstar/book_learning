...
A2C_PATH = "reinforcement_learning_with_python_and_keras_v2/2-cartpole/1-dqn"
    ...
    for e in range(num_episode):
        ...
        while not done:
            ...
            if done:
                ...
                pylab.savefig(f"{A2C_PATH}/save_graph/graph.png")

                # 이동 평균이 400 이상일 때 종료
                if score_avg > 400:
                    agent.model.save_weights(f"{A2C_PATH}/save_model/model", save_format="tf")
                    sys.exit()
